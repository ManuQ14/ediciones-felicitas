...
const { createOrder, handleWebhook, getAdminOrders, getMyOrders, updateOrderStatus, requestCancellation, handleCancellationRequest, confirmDelivery, downloadDigitalFile, deleteOrder, downloadLabel } = require('../controllers/orderController');
...
router.get('/:id/label', verifyToken, downloadLabel);
